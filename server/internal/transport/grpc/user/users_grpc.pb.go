...
const (
	...
	Users_AuthUser_FullMethodName     = "/users.Users/AuthUser"
	Users_DeleteUser_FullMethodName   = "/users.Users/DeleteUser"
	Users_RefreshToken_FullMethodName = "/users.Users/RefreshToken"
)
...
func (c *usersClient) AuthUser(ctx context.Context, in *AuthUserRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	out := new(TokenResponse)
	err := c.cc.Invoke(ctx, Users_AuthUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Users_AuthUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Users_AuthUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
